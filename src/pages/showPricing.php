      ...
      <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <div
          ...
          <p class="mb-6 text-4xl font-bold">
            300 DH<span class="text-xl font-normal text-gray-600">/3 mois</span>
          </p>
          ...
          <button
            class="w-full rounded-lg bg-gray-700 py-3 font-medium text-white transition hover:bg-gray-800">
        ...
        <div
          ...
          <div class="mb-2">
            <p class="text-4xl font-bold">
              500 DH<span class="text-xl font-normal text-gray-600">/6 mois</span>
            </p>
          ...
          <button
            class="w-full rounded-lg bg-indigo-600 py-3 font-medium text-white transition hover:bg-indigo-700">
            Choisir cet abonnement
          </button>
        </div>
        ...
        <div
          ...
          <div class="mb-2">
            <p class="text-4xl font-bold">
              900 DH<span class="text-xl font-normal text-gray-600">/an</span>
            </p>
