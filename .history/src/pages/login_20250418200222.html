      ...
      >
        ...
        >
          <div class="space-y-4 p-6 sm:p-8 md:space-y-6">
            <h1
              class="text-xl leading-tight font-bold tracking-tight text-gray-900 md:text-2xl"
            >
            ...
            >
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-start">
                  ...
                  <div class="ml-3 text-sm">
                    <label for="stayLoged" class="text-gray-500"
              ...
              <button
                type="submit"
                class="w-full bg-orange-500 text-lg text-white"
              >
                Se connecter
              </button>
